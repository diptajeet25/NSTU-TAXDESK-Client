      ...
      <table className="min-w-[900px] w-full text-sm text-left">
          <thead>
            <tr className="bg-primary text-white">
              ...
              <th className="!px-3 !py-4 font-semibold text-md">Date</th>
              ...
              <th className="!px-3 !py-4 font-semibold text-md text-center">Total Amount</th>
              <th className="!px-3 !py-4 font-semibold text-md text-center">Status</th>
  ...
  {isFetching || isLoading ? (
    ...
    recentTransactions.map((item) => (
      <tr key={item.id} className="hover:bg-indigo-50/40 transition-colors">
        ...
        <td className="!px-3 !py-5 text-center ">{item.status}</td>
